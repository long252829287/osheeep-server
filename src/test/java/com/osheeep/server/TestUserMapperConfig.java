...
public class TestUserMapperConfig {
    ...
    @Bean
    public DinnerImageAssetMapper dinnerImageAssetMapper() {
        return Mockito.mock(DinnerImageAssetMapper.class);
    }
    ...
    @Bean
    public DinnerRecipeMethodMapper dinnerRecipeMethodMapper() {
        return Mockito.mock(DinnerRecipeMethodMapper.class);
    }
